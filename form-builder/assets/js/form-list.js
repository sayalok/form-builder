                    ...
                    if(splitKey[0] == 'Fields') {
                        ...
                        newBox.innerHTML += `
                            ...
                            <div class="optDefineDiv">
                                ...
                                <select name="" class="form-control optionType_${splitKey[1]}" required="">
                                    <option value="">Select One</option>
                        ...
                        $('.optionType_'+splitKey[1]).val(item[key].input_type+'_'+splitKey[1])
                        if(item[key].options != undefined) {
                            var optField = document.createElement("div");
                            optField.className = "edit_optionFieldsWrapper";
